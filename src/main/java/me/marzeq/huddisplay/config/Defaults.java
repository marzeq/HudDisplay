...
public class Defaults {
    ...
    // Order
    public static Config.Line[] defaultOrder = new Config.Line[]{Config.Line.FPS, Config.Line.XYZ, Config.Line.PING, Config.Line.PLAYER_NAME, Config.Line.LIGHT_LEVEL, Config.Line.SYSTEM_TIME};
